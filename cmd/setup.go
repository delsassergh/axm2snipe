...
func runSetup(cmd *cobra.Command, args []string) error {
	...
	fields := []snipe.FieldDef{
		...
		{Name: "AXM: AppleCare Agreement", Element: "text", Format: "ANY", HelpText: "AppleCare agreement or contract number"},
		{Name: "AXM: AppleCare Description", Element: "text", Format: "ANY", HelpText: "AppleCare coverage description"},
		{Name: "AXM: AppleCare End Date", Element: "text", Format: "DATE", HelpText: "AppleCare coverage end date"},
